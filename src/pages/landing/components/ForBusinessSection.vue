...
const icons = [ChartBarIcon, QrCodeIcon, MegaphoneIcon, ClipboardDocumentCheckIcon]

const { t, tm } = useI18n()
const { target, isVisible } = useReveal()

const items = tm('landing.forBusiness.items') as AudienceFeature[]
</script>

<template>
  <section id="for-business" ref="target" class="border-y border-border bg-surface-raised py-28">
    <div class="mx-auto max-w-6xl px-6">
      ...
      <div class="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          <div
            class="flex h-11 w-11 items-center justify-center rounded-xl bg-brand-600 text-white"
          >
